...
class BabyGame {
    ...
    createShapeAt(x, y) {
        ...
        if (this.musicSystem) {
            ...
            // 添加音符視覺效果
            this.musicVisualizer.addNoteEffect(x, y, currentNote, this.canvas);
        }
    ...
    createMusicButton() {
        ...
        this.musicButton.innerHTML = `
            ...
            <div class="music-text">
                <div class="song-name">點擊開始</div>
                <div class="song-hint">點擊選擇歌曲</div>
            </div>
        `;
    ...
    updateMusicButton() {
        if (this.musicButton && this.musicSystem) {
            ...
            hintElement.textContent = `${songInfo.progress}/${songInfo.total} | 點擊切換`;
        }
    }
}
